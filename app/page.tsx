...
export default function HomePage() {
  ...
  const handleSearch = async (customQuery?: string) => {
    ...
    try {
      ...
      // Verification: Does the data have what we need?
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <h4 className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Market Deals</h4>
                    {analysis.main_product?.new_deals?.map((d:any, i:number) => (
                      <a key={i} href={d.url} target="_blank" className="flex justify-between items-center p-5 bg-white/5 rounded-2xl border border-white/5 hover:border-indigo-500 transition group">
